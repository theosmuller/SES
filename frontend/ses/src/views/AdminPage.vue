<template>
    ...
    <div class="admin-page">
      <div class="side-menu">
        ...
        >
          <i class="pi pi-search"></i> SEARCH/EDIT CLASS
        </div>
        <div
          class="menu-item"
        ...
        >
          <i class="pi pi-plus-circle"></i> ADD CLASS
        </div>
        <div
          class="menu-item"
        ...
        >
          <i class="pi pi-calendar"></i> SET ENROLLMENT DATES
        </div>
        <div
  ...
  import AddClassMenu from '../components/AddClassMenu.vue';
